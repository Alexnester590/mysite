...
//конец третьей карты
    	...
    	$.getJSON("service11.php?action=getAllSightings", function(json) {
	...
	function getSightingsByType(type){
		$.getJSON("service11.php?action=getSightingsByType&type="+type, function(json)
		{
	...
	function getAllTypes(){
    	$.getJSON("service11.php?action=getSightingsTypes", function(json_types) {
